...
pt_students_df.groupby('Year').Age.median()

pt_students_df.groupby('Year').Age.min()

pt_students_df.groupby('Year').Age.max()

pt_students_df.DA_mark.count()

pt_students_df.DA_mark.nunique()